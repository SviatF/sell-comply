...
const statements = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_events_legacy ON regulatory_change_events(legacy_change_id)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_events_source ON regulatory_change_events(source_id, detected_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_events_rule ON regulatory_change_events(rule_key, detected_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_events_type ON regulatory_change_events(event_type, detected_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_events_decision ON regulatory_change_events(decision, reviewed_at)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_regulatory_change_impact_unique ON regulatory_change_impacts(change_event_id, rule_key, rule_version, market_slug, product_slug, impact_phase)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_impacts_event ON regulatory_change_impacts(change_event_id)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_impacts_market_product ON regulatory_change_impacts(market_slug, product_slug, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_change_impacts_rule ON regulatory_change_impacts(rule_key, rule_version)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_regulatory_update_reviews_outcome ON regulatory_update_reviews(triage_outcome, reviewed_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_update_reviews_rule_update ON regulatory_update_reviews(requires_rule_update, reviewed_at)`,
