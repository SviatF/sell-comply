...
const statements = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_regulatory_source_registry_authority ON regulatory_source_registry(authority_slug)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_source_registry_jurisdiction ON regulatory_source_registry(jurisdiction_slug)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_source_registry_kind ON regulatory_source_registry(source_kind)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_regulatory_source_market_unique ON regulatory_source_markets(source_id, market_slug)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_source_market_lookup ON regulatory_source_markets(market_slug, source_id)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_regulatory_rule_source_unique ON regulatory_rule_sources(rule_key, rule_version, source_id)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_rule_source_rule ON regulatory_rule_sources(rule_key, rule_version, is_current)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_rule_source_source ON regulatory_rule_sources(source_id, is_current)`,
  ...
  `CREATE UNIQUE INDEX IF NOT EXISTS idx_regulatory_rule_review_unique ON regulatory_rule_review_state(rule_key, rule_version)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_rule_review_reviewed ON regulatory_rule_review_state(last_reviewed_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_rule_review_verified ON regulatory_rule_review_state(last_verified_at)`,
  `CREATE INDEX IF NOT EXISTS idx_regulatory_rule_review_source ON regulatory_rule_review_state(verified_source_id)`,
];
